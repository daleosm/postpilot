...
# variable solely so a prior HA tfvars file can move here without a rewrite.
variable "deployment_profile" {
  ...
  validation {
    ...
    error_message = "This root is permanently the two-AZ HA topology. Use deploy/eks-demo/terraform for the low-cost demo."
  }
}
...
variable "rds_final_snapshot_identifier" {
  ...
  type        = string
  default     = "cutluma-production-final-snapshot"
  nullable    = true
...
variable "prometheus_retention" {
  description = "Prometheus metric retention for the facility deployment."
  type        = string
  default     = "15d"
}

variable "prometheus_storage_size" {
  description = "Persistent gp3 volume size for HA Prometheus metrics."
  type        = string
  default     = "30Gi"
}

variable "grafana_storage_size" {
  description = "Persistent gp3 volume size for HA Grafana dashboards and configuration."
  type        = string
  default     = "10Gi"
}

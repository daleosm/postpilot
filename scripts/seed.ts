...
async function seedTenant(tenant: TenantSeed) {
  ...
  await db.insert(bookings).values([
    ...
    { id: bookingId(9), organizationId: tenant.id, roomId: roomId(2), episodeId: episodeId(9), personId: byRole("editor"), title: `${episodeRows[8].productionCode} client pencil hold`, startsAt: at(4, 10), endsAt: at(4, 15), isOption: true, optionRank: 1, status: "tentative", bookingType: "edit", notes: "First pencil hold; confirm only once the client releases the room." },
    { id: bookingId(10), organizationId: tenant.id, roomId: roomId(2), episodeId: episodeId(10), personId: byRole("editor"), title: `${episodeRows[9].productionCode} alternate client pencil`, startsAt: at(4, 10), endsAt: at(4, 15), isOption: true, optionRank: 2, status: "tentative", bookingType: "edit", notes: "Second pencil hold competing for the same editorial window." },
  ]);

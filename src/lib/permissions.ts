...
export const permissions = ["manage_shows", "manage_bookings", "manage_reviews", "approve_reviews", "manage_work_orders", "update_assigned_work", "approve_time", "manage_rates", "approve_rate_overrides", "approve_po_overruns", "manage_qc", "verify_qc", "waive_qc", "manage_budget", "request_catering", "manage_catering", "view_assigned"] as const;

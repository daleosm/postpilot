...
export const personRole = pgEnum("person_role", ["producer", "post_supervisor", "head_of_production", "finance", "editor", "assistant_editor", "colorist", "sound_mixer", "vfx_coordinator", "qc", "director", "network", "client", "runner", "freelancer"]);

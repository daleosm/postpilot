...
type Request = { id: string; requestType: string; item: string; quantity: number; notes: string | null; requestedFor: Date | string | null; status: string; roomName: string | null; bookingTitle: string | null; episodeTitle: string | null; requesterName: string | null };

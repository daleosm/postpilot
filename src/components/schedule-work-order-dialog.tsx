...
export type SchedulableWorkOrder = { id: string; title: string; showTitle: string; episodeTitle: string; episodeNumber: number; workflowStageName: string | null; dueAt: Date | null; commercialTreatment: "wet_hire" | "dry_hire" | "flat_project_fee" };

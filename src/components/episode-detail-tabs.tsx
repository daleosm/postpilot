...
export function EpisodeDetailTabs({ data, canManageWorkOrders, canUpdateWorkOrders, canManageCommercial, canManageQc, canVerifyQc, canWaiveQc, canApproveReviews, currentPersonId }: { data: WorkspaceData; canManageWorkOrders: boolean; canUpdateWorkOrders: boolean; canManageCommercial: boolean; canManageQc: boolean; canVerifyQc: boolean; canWaiveQc: boolean; canApproveReviews: boolean; currentPersonId: string | null }) {
  ...
  return (
    <section className="panel overflow-hidden">
      ...
      <div className="p-5"><TabContent tab={tab} data={data} canManageWorkOrders={canManageWorkOrders} canUpdateWorkOrders={canUpdateWorkOrders} canManageCommercial={canManageCommercial} canManageQc={canManageQc} canVerifyQc={canVerifyQc} canWaiveQc={canWaiveQc} canApproveReviews={canApproveReviews} currentPersonId={currentPersonId} /></div>
    </section>
  );
}

function TabContent({ tab, data, canManageWorkOrders, canUpdateWorkOrders, canManageCommercial, canManageQc, canVerifyQc, canWaiveQc, canApproveReviews, currentPersonId }: { tab: TabName; data: WorkspaceData; canManageWorkOrders: boolean; canUpdateWorkOrders: boolean; canManageCommercial: boolean; canManageQc: boolean; canVerifyQc: boolean; canWaiveQc: boolean; canApproveReviews: boolean; currentPersonId: string | null }) {

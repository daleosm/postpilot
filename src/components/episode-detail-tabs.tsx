...
export function EpisodeDetailTabs({ data, canManageEpisodes, canManageWorkOrders, canApproveWorkOrders, canUpdateWorkOrders, canManageCommercial, canManageQc, canVerifyQc, canWaiveQc, canApproveReviews, currentPersonId }: { data: WorkspaceData; canManageEpisodes: boolean; canManageWorkOrders: boolean; canApproveWorkOrders: boolean; canUpdateWorkOrders: boolean; canManageCommercial: boolean; canManageQc: boolean; canVerifyQc: boolean; canWaiveQc: boolean; canApproveReviews: boolean; currentPersonId: string | null }) {
...
function TabContent({ tab, data, canManageEpisodes, canManageWorkOrders, canApproveWorkOrders, canUpdateWorkOrders, canManageCommercial, canManageQc, canVerifyQc, canWaiveQc, canApproveReviews, currentPersonId }: { tab: TabName; data: WorkspaceData; canManageEpisodes: boolean; canManageWorkOrders: boolean; canApproveWorkOrders: boolean; canUpdateWorkOrders: boolean; canManageCommercial: boolean; canManageQc: boolean; canVerifyQc: boolean; canWaiveQc: boolean; canApproveReviews: boolean; currentPersonId: string | null }) {

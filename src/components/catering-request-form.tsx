...
type Resources = { rooms: Array<{ id: string; name: string; type: string }>; activeBooking: { id: string; roomId: string; roomName: string } | null; activeWorkOrder: { id: string; episodeId: string; title: string } | null };

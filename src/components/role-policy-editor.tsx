...
const permissionLabels: Record<string, string> = {
  ...
  manage_workflow_configuration: "Configure workflow",
  manage_workflow_stages: "Manage all workflow stages",
  update_assigned_workflow_work: "Update assigned workflow work",
  submit_workflow_stages: "Submit workflow stages",
  sign_off_workflow_stages: "Sign off assigned workflow stages",
  ...
  authorize_early_starts: "Authorise early starts",
  manage_delivery_profiles: "Manage delivery profiles",
  manage_episode_manifests: "Manage episode delivery manifests",
  update_delivery_items: "Update delivery items",
  confirm_delivery_receipt: "Confirm delivery receipt",
  view_shared_delivery_status: "View shared delivery status",

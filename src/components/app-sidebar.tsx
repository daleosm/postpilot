...
export async function AppSidebar() {
  const [person, context, mayManageShows, mayManageUsers, mayManageDeliveryProfiles, permitted] = await Promise.all([
    getCurrentPerson(), getActiveOrganizationContext(), can("manage_shows"), can("manage_users"), can("manage_delivery_profiles"),

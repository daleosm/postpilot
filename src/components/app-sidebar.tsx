...
import { listWorkflowApprovalInbox } from "@/server/data";
...
const navigation = [
  ...
  { label: "Review", icon: FileCheck2, href: "/review", permissions: ["manage_reviews", "approve_reviews", "update_notes"] as Permission[] },

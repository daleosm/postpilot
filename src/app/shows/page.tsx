...
export default async function ShowsPage() {
  ...
  return <div className="pp-page">
    <PageHeader eyebrow={`Shows · ${data.organizationName}`} title="Shows in post" description="Portfolio health across production and spend." action={mayManageShows ? <ShowFormDialog companies={data.companies ?? []} /> : undefined} />

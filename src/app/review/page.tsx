...
export default async function ApprovalsPage() {
  ...
  return (
    <div className="pp-page">
      <PageHeader eyebrow={`Approvals · ${context?.organization?.organizationName ?? "No workspace"}`} title="Approvals" description="Workflow gates awaiting sign-off and practical post work assigned to you." metrics={[{ label: "Sign-offs", value: visibleSignOffs.length, tone: visibleSignOffs.length ? "warning" : "success" }, { label: "Work orders", value: visibleWorkOrders.length }]} />

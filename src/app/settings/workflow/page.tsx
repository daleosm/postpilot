...
export default async function WorkflowSettingsPage() {
  ...
  const [workflow, roles, mayManageUsers] = await Promise.all([getDefaultWorkflowConfig(context.organization.organizationId), getTenantRolePolicies(context.organization.organizationId), can("manage_users")]);

...
export async function POST(request: Request) {
  ...
  const missing = await missingTenantReferences(context.organization.organizationId, { roomId: parsed.data.roomId, episodeId: parsed.data.episodeId, personId: parsed.data.personId, contactId: parsed.data.clientContactId });
